<div class="bg-white border border-gray-200 rounded-lg mb-4 overflow-hidden">
    ...
    <div class="flex items-center justify-between px-3 py-2.5">
        <div class="flex items-center gap-2.5">
            <img src="<?php echo e($atendimento->foto ? Storage::url($atendimento->foto) : 'https://ui-avatars.com/api/?name=' . urlencode($atendimento->nome_assistido) . '&size=40&background=efefef&color=333'); ?>"
                class="w-20 h-20 rounded-full object-cover border border-gray-200" />
            <div>
                <p class="text-sm font-semibold text-gray-900 leading-tight"><?php echo e($atendimento->nome_assistido); ?></p>
                <p class="text-xs text-gray-400 leading-tight"> <?php echo e($atendimento->endereco); ?></p>
                <p class="text-xs text-gray-400 leading-tight"><?php echo e($atendimento->bairro); ?>, <?php echo e($atendimento->cidade); ?></p>
                <p class="text-xs text-gray-400 leading-tight">Bloco: <?php echo e($atendimento->bloco?->nome); ?></p>
                <p class="text-xs text-gray-400 leading-tight">Região: <?php echo e($atendimento->regiao?->nome); ?></p>
                <p class="text-xs text-gray-400 leading-tight">Igreja: <?php echo e($atendimento->igreja?->nome); ?></p>
                <p class="text-xs text-gray-400 leading-tight">Contato:
                    <?php echo e(preg_replace('/(\d{2})(\d{1})(\d{4})(\d{4})/', '($1) $2 $3-$4', preg_replace('/\D/', '', $atendimento->contato))); ?>

                </p>
            </div>
        </div>
        <a href="<?php echo e(route('perfil', $atendimento->voluntario->id)); ?>" class="flex items-center gap-1.5 group">
            <div class="text-right">
                <p class="text-xs font-semibold text-gray-700 group-hover:text-purple-600 leading-tight">
                    <?php echo e($atendimento->voluntario->name); ?></p>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($atendimento->voluntario->condicao): ?>
                    <p class="text-xs text-gray-400 leading-tight"><?php echo e(ucfirst($atendimento->voluntario->condicao)); ?>

                    </p>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            <img src="<?php echo e($atendimento->voluntario->avatar ? Storage::url($atendimento->voluntario->avatar) : 'https://ui-avatars.com/api/?name=' . urlencode($atendimento->voluntario->name) . '&size=32&background=833ab4&color=fff'); ?>"
                class="w-8 h-8 rounded-full object-cover border-2 border-transparent group-hover:border-purple-400 transition-colors" />
        </a>
    </div>

    
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($atendimento->imagem): ?>
        <img src="<?php echo e(Storage::url($atendimento->imagem)); ?>" class="w-full object-cover" style="max-height: 400px;" />
    <?php else: ?>
        <div class="w-full flex items-center justify-center py-8"
            style="background: linear-gradient(135deg, #f5f5f5, #efefef);">
            <span class="text-5xl font-bold text-gray-300"><?php echo e(mb_substr($atendimento->nome_assistido, 0, 1)); ?></span>
        </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="px-3 pt-2 pb-1 flex items-center gap-3">
        ...
        <button wire:click="toggleComentarios" class="focus:outline-none">
            <svg class="w-6 h-6 <?php echo e($mostrarComentarios ? 'text-purple-500' : 'text-gray-800'); ?>" fill="none"
                stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round"
                    d="M12 20.25c4.97 0 9-3.694 9-8.25s-4.03-8.25-9-8.25S3 7.444 3 12c0 2.104.859 4.023 2.273 5.48.432.447.74 1.04.586 1.641a4.483 4.483 0 01-.923 1.785A5.969 5.969 0 006 21c1.282 0 2.47-.402 3.445-1.087.81.22 1.668.337 2.555.337z" />
            </svg>
        </button>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ehDono): ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($atendimento->curtidas_count > 0): ?>
        <p class="px-3 text-sm font-semibold text-gray-900"><?php echo e($atendimento->curtidas_count); ?>

            curtida<?php echo e($atendimento->curtidas_count > 1 ? 's' : ''); ?></p>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    
    <div class="px-3 py-2" x-data="{ expandido: false }">
        <p class="text-sm font-semibold text-gray-800 mb-1"><?php echo e($atendimento->titulo); ?></p>
        <div x-show="!expandido">
            <p class="text-sm text-gray-800">
                <?php echo e(mb_strlen($atendimento->descricao) > 150 ? mb_substr($atendimento->descricao, 0, 150) . '...' : $atendimento->descricao); ?>

            </p>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(mb_strlen($atendimento->descricao) > 150): ?>
                <button @click="expandido = true" class="text-xs text-gray-400 hover:text-gray-600">leia mais</button>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
        <div x-show="expandido">
            <p class="text-sm text-gray-800"><?php echo e($atendimento->descricao); ?></p>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$mostrarComentarios): ?>
        <div class="px-3 py-1 flex items-center gap-2">
            <img src="<?php echo e(auth()->user()->avatar ? Storage::url(auth()->user()->avatar) : 'https://ui-avatars.com/api/?name=' . urlencode(auth()->user()->name) . '&size=28&background=833ab4&color=fff'); ?>"
                class="w-7 h-7 rounded-full object-cover flex-shrink-0" />
            <button wire:click="toggleComentarios" class="flex-1 text-left text-sm text-gray-400 hover:text-gray-600">
                <?php echo e($atendimento->comentarios_count > 0 ? 'Ver ' . $atendimento->comentarios_count . ' comentário(s)...' : 'Adicione um comentário...'); ?>
        ...
        <div class="px-3 py-2 space-y-2">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $comentarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comentario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex gap-2">
                    <img src="<?php echo e($comentario->user->avatar ? Storage::url($comentario->user->avatar) : 'https://ui-avatars.com/api/?name=' . urlencode($comentario->user->name) . '&size=28&background=833ab4&color=fff'); ?>"
                        class="w-7 h-7 rounded-full object-cover flex-shrink-0" />
                    <div class="flex-1">
    ...
    <p class="px-3 pb-2 text-xs text-gray-400 uppercase tracking-wide">
        <?php echo e($atendimento->data_atendimento->format('d/m/Y')); ?></p>

    
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($atualizacoes->count() > 0): ?>
        <div class="border-t border-gray-100">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $atualizacoes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $atualizacao): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('card-atualizacao', ['atualizacao' => $atualizacao]);

$__key = 'atualiz-' . $atualizacao->id;

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-198614583-0', $__key);
...
?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mostrarAtualizacao && $ehDono): ?>
        <div class="border-t border-gray-100 px-3 py-3 space-y-2 bg-gray-50">
            ...
            <div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fotoAtualizacao): ?>
                    <img src="<?php echo e($fotoAtualizacao->temporaryUrl()); ?>"
...
<?php /**PATH /var/www/html/resources/views/livewire/card-atendimento.blade.php ENDPATH**/ ?>